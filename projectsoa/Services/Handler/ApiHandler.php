...
class ApiHandler
{
     ...
     * @return BaseResponse
     */
    public static function request($method, $url, $params = [], $headers = [], $multipart = false, $useAccessToken = true, $isFile = false, $isReportingService = false, $isKmaService = false)
    {
        // get base url from environtment
        $client = new Client(['base_uri' => env($isReportingService ? "REPORTING_API_BASE_URL" : ($isKmaService ? "KMA_API_BASE_URL" : "API_BASE_URL"))]);
     ...
     * @return BaseResponse
     */
    public static function requestMultipart($method, $url, $params = [], $headers = [], $useAccessToken = true, $isKmaService = false)
    {
        return ApiHandler::request($method, $url, $params, $headers, true, $useAccessToken, false, false, $isKmaService);
    }
